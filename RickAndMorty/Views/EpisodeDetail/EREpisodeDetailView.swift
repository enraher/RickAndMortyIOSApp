...
protocol EREpisodeDetailViewDelegate: AnyObject{
    func erhEpisodeDetailView(_ detailView: EREpisodeDetailView,
                             didSelect character: ERCharacter
    )
}

final class EREpisodeDetailView: UIView {

    public weak var delegate: EREpisodeDetailViewDelegate?
    
    private var viewModel: EREpisodeDetailViewViewModel? {
        didSet {
    ...
    public func configure(with viewModel: EREpisodeDetailViewViewModel) {
...
extension EREpisodeDetailView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .characters:
            ...
            delegate?.erhEpisodeDetailView(self, didSelect: character)
        }
    }
