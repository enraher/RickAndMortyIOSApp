//
//  ERCharacterInfoCollectionViewCell.swift
//  RickAndMorty
//
...
final class ERCharacterInfoCollectionViewCell: UICollectionViewCell {
    
    static let cellIdentifier = "ERCharacterInfoCollectionViewCell"
    ...
    public func configure(with viewModel: ERCharacterInfoCollectionViewCellViewModel){
