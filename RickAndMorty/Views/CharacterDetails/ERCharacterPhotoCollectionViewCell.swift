//
//  ERCharacterPhotoCollectionViewCell.swift
//  RickAndMorty
//
...
final class ERCharacterPhotoCollectionViewCell: UICollectionViewCell {
    static let cellIdentifier = "ERCharacterPhotoCollectionViewCell"
...
//        contentView.layer.shadowOpacity = 0.3
    ...
    public func configure(with viewModel: ERCharacterPhotoCollectionViewCellViewModel) {
